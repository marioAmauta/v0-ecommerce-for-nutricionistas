...
const products = [
  {
    ...
    badge: "Más Vendido",
    description:
      "Caliper de precisión para medición de pliegues cutáneos, estándar ISAK"
  },
  {
    id: 2,
    ...
    brand: "Lufkin",
    description:
      "Cinta métrica de acero inextensible, 2 metros, certificada ISAK"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    badge: "Nuevo",
    description:
      "Certificación internacional en antropometría, modalidad online + práctica"
  },
  {
    id: 6,
  ...
  },
  {
    ...
    badge: "Digital",
    description:
      "Hoja de cálculo avanzada con fórmulas automáticas y bases de datos"
  },
  {
    id: 8,
    ...
    description:
      "Guía completa de técnicas antropométricas y su aplicación clínica"
  }
];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Encuentra todos los equipos y recursos que necesitas para tu práctica
          nutricional
        </p>
      </div>
          ...
          >
            {sortedProducts.map((product) => (
              ...
              >
                  ...
                  <div className="relative">
                    <Image
                      ...
                      className={`object-cover rounded-t-lg ${
                        viewMode === "list"
                          ? "w-full h-48 rounded-l-lg rounded-t-none"
                          : "w-full h-48"
                      }`}
                    />
                    {product.badge && (
                ...
                <div
                  className={viewMode === "list" ? "flex flex-col flex-1" : ""}
                >
