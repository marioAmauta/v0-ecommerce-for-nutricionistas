...
const brands = ["Todos", "Harpenden", "Seca", "Lufkin", "ISAK", "NutriStore", "Editorial Médica"]
const priceRanges = [
                ...
                <CardHeader className={`p-0 ${viewMode === "list" ? "w-48 flex-shrink-0" : ""}`}>
                  <div className="relative">
                    <Image
                      ...
                      width={300}
                      height={300}
                      className={`object-cover rounded-t-lg ${viewMode === "list" ? "w-full h-48 rounded-l-lg rounded-t-none" : "w-full h-48"}`}
                    />
                    {product.badge && (
                      <Badge
