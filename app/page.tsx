...
import { ShoppingCart, Star, Users, BookOpen, Calculator, Ruler } from "lucide-react"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Categorías Especializadas</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <Link key={index} href={`/categoria/${category.name.toLowerCase().replace(/\s+/g, "-")}`}>
                <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
                  <CardContent className="p-6">
                    <div className="relative mb-4">
                      ...
                      />
                      <div className="absolute inset-0 bg-green-600/20 rounded-lg group-hover:bg-green-600/30 transition-colors" />
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Soporte Especializado</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Recursos Actualizados</h3>
