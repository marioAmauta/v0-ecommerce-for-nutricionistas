        ...
        <Card className="shadow-xl border-0">
                ...
                {formData.profession === "nutricionista" ? (
                  <div className="space-y-2 mt-4">
                    ...
                    <p className="text-xs text-gray-500">
                      Esto nos ayuda a verificar tu estatus profesional para
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <label
                    ...
                    className="text-sm text-gray-600 leading-relaxed"
                  >
                    Quiero recibir actualizaciones sobre nuevos productos,
                    cursos ISAK y contenido profesional
                  </label>
                </div>
              </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-center text-sm text-gray-600">
              ...
              <Link
                href="/iniciar-sesion"
                className="text-color1 hover:text-color2 font-medium"
              >
                Inicia sesión aquí
              </Link>
            </div>
